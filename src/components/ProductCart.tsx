    ...
    <div>
      <div className="container mx-auto mt-10">
        <div className="flex shadow-md my-10">
          <div className="w-3/4 bg-white px-10 py-10 rounded-md">
            <div className="flex justify-between border-b pb-8">
              <h1 className="font-semibold text-2xl">Shopping Cart</h1>
              <h2 className="font-semibold text-md">Total Items {totalQuantity}</h2>
            </div>
          ...
          <div id="summary" className="w-1/4 px-8 py-10 text-zinc-300">
      ...
      <input type="text" id="promo" value= {promo} onChange={(e : any) => setPromo(e.target.value)} placeholder="Enter your code" className="p-2 text-sm w-full"/>
    </div>
